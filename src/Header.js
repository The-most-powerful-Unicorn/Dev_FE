        ...
        <header id="header">
            <nav id="header-wrap" className="cf">
                <h1 id="logo">
                            <Link to='/'>
                                <img
                                    src="http://dev-2.d2em5p6udhtx56.amplifyapp.com/img/logo-2.png"/></Link>
                </h1>
                <ul id="header-nav">
                    <li><span className="header-navBtn ">About</span>
                        <ul className="header-sub-ul">
                            <li className="header-sub-li"><Link to='/About'>서비스 소개</Link></li>
                        </ul>
                    </li>
                ...
                <ul id="header-nav2">
                    <li>
                        <span className="header-icon "><img src='http://dev-2.d2em5p6udhtx56.amplifyapp.com/img/heart_black.png' width='22' /></span>
                    </li>
                    <li>
                        <span className="header-icon"><img src='http://dev-2.d2em5p6udhtx56.amplifyapp.com/img/shopping_black.png' width='22' /></span>
                    </li>
                    <li>
                        <span className="header-icon"><img src='http://dev-2.d2em5p6udhtx56.amplifyapp.com/img/search_black.png' width='22' /></span>
                    </li>
                    <li>
